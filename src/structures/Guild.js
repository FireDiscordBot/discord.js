 ...
 * @internal
 */
const deletedGuilds = new LimitedCollection({
...
class Guild extends AnonymousGuild {
   ...
   */
  get deleted() {
    return deletedGuilds.has(this.id);
  }
  ...
  get deletedTimestamp() {
    return deletedGuilds.get(this.id);
  }
   ...
   */
  get deletedAt() {
    return this.deleted && new Date(deletedGuilds.get(this.id));
  }

  set deleted(value) {
    if (value) deletedGuilds.set(this.id, Date.now());
    else deletedGuilds.delete(this.id);
  }
